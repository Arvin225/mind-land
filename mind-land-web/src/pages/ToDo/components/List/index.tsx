            ...
            {contextMenu && (
                ...
                >
                    <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-[--foreground]/80 hover:bg-hover transition-colors cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-red-400 hover:bg-hover transition-colors cursor-pointer"
                    >
                        <Trash2 className="w-3 h-3" />
                        删除
                    </button>
